...
### Usage
The add-on injects a dropdown above the usual `Preferences > Keymap` menu, allowing
the user to select an input keyboard layout on top of which to emulate QWERTY.
This dropdown includes buttons to add and edit new custom keyboard layouts, as well
...
or read/edit it directly in [this repository](https://github.com/endorh/blender-keyboard-layout-emulation/tree/docs).
